...
export const useSound = () => {
  ...
  useEffect(() => {
    ...
    if (audioRefs.current.rumble) {
      audioRefs.current.rumble.volume = 0.85; // Higher volume for the rumble sound
    }
